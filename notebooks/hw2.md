...
<a href="https://www.codecogs.com/eqnedit.php?latex=p_{pooled}&space;=&space;\frac{X_1&plus;X_2}{N_1&space;&plus;&space;N_2}&space;=&space;\frac{5901&space;&plus;&space;6012}{59504&plus;58944}&space;=&space;0.1\\\\&space;\sigma^2_{pooled}&space;=&space;p*(1-p)&space;=&space;0.1*(1-0.1)&space;=&space;0.09\\\\&space;\therefore&space;var&space;=&space;\sigma^2_{pooled}(\frac{1}{n_{red}}&space;&plus;&space;\frac{1}{n_{gold}})&space;=&space;0.09(\frac{1}{59504}&plus;\frac{1}{58944})&space;=&space;3.039\times10^{-6}" target="_blank"><img src="https://latex.codecogs.com/svg.latex?p_{pooled}&space;=&space;\frac{X_1&plus;X_2}{N_1&space;&plus;&space;N_2}&space;=&space;\frac{5901&space;&plus;&space;6012}{59504&plus;58944}&space;=&space;0.1\\\\&space;\sigma^2_{pooled}&space;=&space;p*(1-p)&space;=&space;0.1*(1-0.1)&space;=&space;0.09\\\\&space;\therefore&space;var&space;=&space;\sigma^2_{pooled}(\frac{1}{n_{red}}&space;&plus;&space;\frac{1}{n_{gold}})&space;=&space;0.09(\frac{1}{59504}&plus;\frac{1}{58944})&space;=&space;3.039\times10^{-6}" title="p_{pooled} = \frac{X_1+X_2}{N_1 + N_2} = \frac{5901 + 6012}{59504+58944} = 0.1\\\\ \sigma^2_{pooled} = p*(1-p) = 0.1*(1-0.1) = 0.09\\\\ \therefore var = \sigma^2_{pooled}(\frac{1}{n_{red}} + \frac{1}{n_{gold}}) = 0.09(\frac{1}{59504}+\frac{1}{58944}) = 3.039\times10^{-6}" /></a>
